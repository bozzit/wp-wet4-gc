            ...
            <div class="container nvbar">
                ...
                <div class="row">
                    <ul class="list-inline menu">
                        <li><a href="http://infranet.ad.infrastructure.gc.ca/en#menu1"><?php _e("<!--:en-->Resources for<!--:--><!--:fr-->Ressources pour<!--:-->"); ?></a>
                        </li>
                        <li><a href="http://infranet.ad.infrastructure.gc.ca/en#menu2"><?php _e("<!--:en-->Office Tools<!--:--><!--:fr-->Outils pour le bureau<!--:-->"); ?></a>
                        </li>
                        <li><a href="http://infranet.ad.infrastructure.gc.ca/en#menu3"><?php _e("<!--:en-->INFC Branches<!--:--><!--:fr-->Directions d'INFC<!--:-->"); ?></a>
                        </li>
                        <li><a href="http://infranet.ad.infrastructure.gc.ca/en#menu4"><?php _e("<!--:en-->Initiatives<!--:--><!--:fr-->Initiatives<!--:-->"); ?></a>
                        </li>
                        <li><a href="http://infranet.ad.infrastructure.gc.ca/en#menu5"><?php _e("<!--:en-->GoC Sites<!--:--><!--:fr-->Sites du GC<!--:-->"); ?></a>
                        </li>
                        <li><a href="http://infranet.ad.infrastructure.gc.ca/en#menu6"><?php _e("<!--:en-->My Links<!--:--><!--:fr-->Mes Liens<!--:-->"); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
